...
class Investment(TimeStampedModel):
    ...
    QUESTION_PAGE_2_Q1_OPTION_A = "most_people"
    QUESTION_PAGE_2_Q1_OPTION_B = "cant_be_too_careful"
    QUESTION_PAGE_2_Q1_OPTION_C = "dont_know"
    QUESTION_PAGE_2_Q1_OPTION_D = "refuse_to_answer"
    QUESTION_PAGE_2_Q1_CHOICES = (
        (QUESTION_PAGE_2_Q1_OPTION_A, "Most people can be trusted"),
        (QUESTION_PAGE_2_Q1_OPTION_B, "Can't be too careful"),
        (QUESTION_PAGE_2_Q1_OPTION_C, "Don't know"),
        (QUESTION_PAGE_2_Q1_OPTION_D, "Refuse to answer"),
    )

    # Are you a U.S. citizen?
    QUESTION_PAGE_2_Q3_OPTION_A = "yes"
    QUESTION_PAGE_2_Q3_OPTION_B = "no"
    QUESTION_PAGE_2_Q3_OPTION_C = "dont_know"
    QUESTION_PAGE_2_Q3_OPTION_D = "refuse_to_answer"
    QUESTION_PAGE_2_Q3_CHOICES = (
        (QUESTION_PAGE_2_Q3_OPTION_A, "Yes"),
        (QUESTION_PAGE_2_Q3_OPTION_B, "No"),
        (QUESTION_PAGE_2_Q3_OPTION_C, "Don't know"),
        (QUESTION_PAGE_2_Q3_OPTION_D, "Refuse to answer"),
    )

    # Valid question2_5 choices:
    # --------------------------
    # Did you vote for a presidential candidate in the last election?
    QUESTION_PAGE_2_5_Q1_OPTION_A = "yes"
    QUESTION_PAGE_2_5_Q1_OPTION_B = "no"
    QUESTION_PAGE_2_5_Q1_OPTION_C = "dont_know"
    QUESTION_PAGE_2_5_Q1_OPTION_D = "refuse_to_answer"
    QUESTION_PAGE_2_5_Q1_CHOICES = (
        (QUESTION_PAGE_2_5_Q1_OPTION_A, "Yes"),
        (QUESTION_PAGE_2_5_Q1_OPTION_B, "No"),
        (QUESTION_PAGE_2_5_Q1_OPTION_C, "Don't know"),
        (QUESTION_PAGE_2_5_Q1_OPTION_D, "Refuse to answer"),
    )

    # Whom did you vote for?
    QUESTION_PAGE_2_5_Q2_OPTION_A = "trump"
    QUESTION_PAGE_2_5_Q2_OPTION_B = "clinton"
    QUESTION_PAGE_2_5_Q2_OPTION_C = "other"
    QUESTION_PAGE_2_5_Q2_OPTION_D = "dont_know"
    QUESTION_PAGE_2_5_Q2_OPTION_E = "refuse_to_answer"
    QUESTION_PAGE_2_5_Q2_CHOICES = (
        (QUESTION_PAGE_2_5_Q2_OPTION_A, "Donald Trump"),
        (QUESTION_PAGE_2_5_Q2_OPTION_B, "Hillary Clinton"),
        (QUESTION_PAGE_2_5_Q2_OPTION_C, "Other"),
        (QUESTION_PAGE_2_5_Q2_OPTION_D, "Don't know"),
        (QUESTION_PAGE_2_5_Q2_OPTION_E, "Refuse to answer"),
    )

    # Are your political views closer to...
    QUESTION_PAGE_2_5_Q3_OPTION_A = "democrats"
    QUESTION_PAGE_2_5_Q3_OPTION_B = "republicans"
    QUESTION_PAGE_2_5_Q3_OPTION_C = "other"
    QUESTION_PAGE_2_5_Q3_OPTION_D = "no_preference"
    QUESTION_PAGE_2_5_Q3_OPTION_E = "dont_know"
    QUESTION_PAGE_2_5_Q3_OPTION_F = "refuse_to_answer"
    QUESTION_PAGE_2_5_Q3_CHOICES = (
        (QUESTION_PAGE_2_5_Q3_OPTION_A, "The Democrats"),
        (QUESTION_PAGE_2_5_Q3_OPTION_B, "The Republicans"),
        (QUESTION_PAGE_2_5_Q3_OPTION_C, "Other"),
        (QUESTION_PAGE_2_5_Q3_OPTION_D, "No preference"),
        (QUESTION_PAGE_2_5_Q3_OPTION_E, "Don't know"),
        (QUESTION_PAGE_2_5_Q3_OPTION_F, "Refuse to answer"),
    )
    ...
    QUESTION_PAGE_3_Q1_OPTION_A = "get_better"
    QUESTION_PAGE_3_Q1_OPTION_B = "stay_the_same"
    QUESTION_PAGE_3_Q1_OPTION_C = "get_worse"
    QUESTION_PAGE_3_Q1_OPTION_D = "dont_know"
    QUESTION_PAGE_3_Q1_OPTION_E = "refuse_to_answer"
    QUESTION_PAGE_3_Q1_CHOICES = (
        (QUESTION_PAGE_3_Q1_OPTION_A, "Get better"),
        (QUESTION_PAGE_3_Q1_OPTION_B, "Stay the same"),
        (QUESTION_PAGE_3_Q1_OPTION_C, "Get worse"),
        (QUESTION_PAGE_3_Q1_OPTION_D, "Don't know"),
        (QUESTION_PAGE_3_Q1_OPTION_E, "Refuse to answer"),
    )
    ...
    QUESTION_PAGE_3_Q7_OPTION_A = "very_concerned"
    QUESTION_PAGE_3_Q7_OPTION_B = "somewhat_concerned"
    QUESTION_PAGE_3_Q7_OPTION_C = "not_too_concerned"
    QUESTION_PAGE_3_Q7_OPTION_D = "not_concerned"
    QUESTION_PAGE_3_Q7_OPTION_E = "dont_know"
    QUESTION_PAGE_3_Q7_OPTION_F = "refuse_to_answer"
    QUESTION_PAGE_3_Q7_CHOICES = (
        (QUESTION_PAGE_3_Q7_OPTION_A, "Very concerned"),
        (QUESTION_PAGE_3_Q7_OPTION_B, "Somewhat concerned"),
        (QUESTION_PAGE_3_Q7_OPTION_C, "Not too concerned"),
        (QUESTION_PAGE_3_Q7_OPTION_D, "Not concerned"),
        (QUESTION_PAGE_3_Q7_OPTION_E, "Don't know"),
        (QUESTION_PAGE_3_Q7_OPTION_F, "Refuse to answer"),
    )

    # In general, how well do you think the American government is doing in
    # reducing the threat of terrorism?
    QUESTION_PAGE_3_Q8_OPTION_A = "very_well"
    QUESTION_PAGE_3_Q8_OPTION_B = "fairly_well"
    QUESTION_PAGE_3_Q8_OPTION_C = "not_very_well"
    QUESTION_PAGE_3_Q8_OPTION_D = "not_well_at_all"
    QUESTION_PAGE_3_Q8_OPTION_E = "dont_know"
    QUESTION_PAGE_3_Q8_OPTION_F = "refuse_to_answer"
    QUESTION_PAGE_3_Q8_CHOICES = (
        (QUESTION_PAGE_3_Q8_OPTION_A, "Very well"),
        (QUESTION_PAGE_3_Q8_OPTION_B, "Fairly well"),
        (QUESTION_PAGE_3_Q8_OPTION_C, "Not very well"),
        (QUESTION_PAGE_3_Q8_OPTION_D, "Not well at all"),
        (QUESTION_PAGE_3_Q8_OPTION_E, "Don't know"),
        (QUESTION_PAGE_3_Q8_OPTION_F, "Refuse to answer"),
    )
    ###########################################################################
    ...
    general_trustworthiness = models.CharField(
        max_length=255,
        null=True,
        choices=QUESTION_PAGE_2_Q1_CHOICES,
