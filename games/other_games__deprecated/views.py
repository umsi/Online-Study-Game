"""
NOTE! Views in this app seem to be unused when running the `invest_game` app.
Since running the `invest_game` is the primary purpose of this repository for 
the time being, we've collected all other views here in a generic `other_games`
app, and we've included models that support the extra functionality found here.

However, all this functionality is untested and may be error-prone. Any use of 
this app should be reviewed first and tested before deploying to production.
"""
